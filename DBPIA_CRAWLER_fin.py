...
while True:
    ...
    try:
        for doc in Author.find({"hasInst" : False}).batch_size(1):
            ...
            # Author.update_one({"_id":doc['_id']},{'$set':{"plusName" :new_name,  "inst": inst , "hasInst" : True , "papers_count" : papers_count , "used_count": used_count,'citation_count': citation_count, 'originalName': original_inst}})
