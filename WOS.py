...
#######################################################################################################################################
    ...
    def WOS_checkbox(self):
        ...
        #체크
        self.driver.find_element_by_xpath('/html/body/div[5]/div[2]/div/mat-dialog-container/app-custom-field-selection-dialog/div/div[2]/div/div[1]/div[8]/mat-checkbox/label/span[1]').click()  # 저자식별자체크
...
########################################################################################################################################
    ...
    def WOS(self):
        ...
        try:
            ...
            #Advanced research
            self.driver.find_element_by_xpath('/html/body/app-wos/div/div/main/div/div[2]/app-input-route/app-search-home/div[2]/div/app-input-route/app-search-basic/app-search-form/form/div[2]/a').click()
            time.sleep(2) 
